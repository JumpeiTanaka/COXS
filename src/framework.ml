...
let steps ast0 log timeout dbschema physical =
  ...
  (* ************************************************ *)
  print_endline "(* ************************************************ *)";
  print_endline "(* Step 1: Preperation                              *)";
  print_endline "(* ************************************************ *)";
  ...
  let prep_check_lst = Preperation.check ast_bwd evolved_pred_lst log in
  ...
  let consistency_lst = Consistency.check ast_schemas ast_constraint ast_schevo ast_bwd source_pred_lst evolved_bwd_pred_lst source_ins_rels source_del_rels log timeout in
